#  ---------------------------------------------------------------------------
#
#  Description:   This file holds all my BASH configurations and aliases, largely taken from
...
#   0. NOTES
#   -------------------------------
#   Everything marked with spring-cleanup is project-specific and can be cleaned out at some point
